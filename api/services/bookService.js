...
BookModel.addcategoryOfBook = async(req,res,next)=>{
    const {userId} = req.doc
    try {
        req.body.userId = userId
        let add = await bookModels.addCategory(req.body)
...
BookModel.getcategoryOfBook = async(req,res,next)=>{
    try {
        let add = await bookModels.getCategory(req.doc)
